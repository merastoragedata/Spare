...
var SHEETS = {
  ...
  ITEMS:       ['id', 'categoryId', 'name', 'unit', 'location', 'trackLow', 'lowCutoff', 'unitValue', 'routineTest', 'resultSheetId', 'docMode', 'fields', 'remarks', 'docs', 'createdAt', 'updatedAt'],
  ...
  KITS:        ['id', 'categoryId', 'name', 'ownership', 'ownerDetail', 'status', 'location', 'returnRequired', 'opSheetId', 'fields', 'remarks', 'docs', 'createdAt', 'updatedAt'],
...
var ADMIN_FNS = ['deleteItem', 'deleteCategory', 'deleteRecord', 'deleteKit', 'deleteKitEntry', 'deleteKitIssue', 'deleteReport',
